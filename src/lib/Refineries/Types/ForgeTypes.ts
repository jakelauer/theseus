 ...
 * which is `TParamName`, and a value of type `TData`. They may additionally specify any further
 * arguments as required by the functionality. They must return some type other than TData.
 */
