...
>(
    ...
    const theseusInstance = new Theseus<TData, TObserverType>(rest);
    ...
    const addEvolversAndRefineries = (
        ...
        if (refineries) {
            log.debug(`Refineries found, adding to extension for Theseus instance ${innerInstance.__uuid}`);
            ...
            extension = Object.defineProperties<BaseExtension>({ ...extension, refine: undefined } as any, {
                refine: {
                    get: () => {
